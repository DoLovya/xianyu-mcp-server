...
```bash
/Users/huan.zhang/.trae/tools/uv/latest/uv sync --directory /Users/huan.zhang/Code/xianyu-mcp-server/.mcp/XianYuApis_MCP
```

## 本地启动 MCP

```bash
/Users/huan.zhang/.trae/tools/uv/latest/uv run --directory /Users/huan.zhang/Code/xianyu-mcp-server/.mcp/XianYuApis_MCP server.py
```
...
```bash
/Users/huan.zhang/.trae/tools/uv/latest/uv run --directory /Users/huan.zhang/Code/xianyu-mcp-server/.mcp/XianYuApis_MCP server.py --http
```
